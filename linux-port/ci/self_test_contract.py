...
def main()->int:
    ...
    with tempfile.TemporaryDirectory(prefix='cp-selftest-contract-') as td_raw:
        ...
        if delivery.get('appBuild')!='1.06.00-beta.34-linux-dev.4' or delivery.get('engineVersion')!='0.4.1-linux-dev':raise RuntimeError('HTTP self-test build identity mismatch')
