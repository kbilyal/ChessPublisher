...
def main()->int:
    ...
    with tempfile.TemporaryDirectory(prefix='cp-deb-') as td:
        ...
        package_manifest={'schema':3,'package':PACKAGE,'version':DEB_VERSION,'displayVersion':DISPLAY_VERSION,'appBuild':APP_BUILD,'engineVersion':ENGINE_VERSION,'architecture':'amd64','source':verified,'runtimeFiles':runtime,'selfTestCommand':'chess-publisher-self-test','bytecodeIncluded':False,'minimumNetworkx':'2.6'}
